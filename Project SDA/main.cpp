...
int main() {
	...
	IApplication* newapp2 = new UnpaidLeaveApp(emp2.getID(), 1, "Unpaid", "2", "2-2-2024", "2-2-2024", "2-2-2024", "noreason", "New-zealand");
	ApplyManager->applyLeave(emp2.getID(), newapp2, Unpaid::getInstance());
	cout << endl << endl;

	cout << "[Employee 1] Going to apply Casual Leave: " << endl;
	IApplication* newapp = new DefaultLeaveApplication(emp.getID(), 9, "Casual", "2", "2-2-2024", "2-2-2024", "2-2-2024", "noreason");
